...
const translations = {
  ...
  ka: {
    ...
    'services.ai.title': 'თანამედროვე კონტენტი და ვიზუალი',
    'services.ai.desc': 'ვწერთ მკაფიო ტექსტებს და ვარჩევთ ვიზუალებს, რომ თქვენი სერვისები მარტივად და დამაჯერებლად იყოს წარმოდგენილი. ყველაფერი ერთ სტილში — სუფთად და პროფესიონალურად.',
    ...
    'about.desc1': 'მჯერა, რომ ყველა ადგილობრივ ბიზნესს ეკუთვნის ძლიერი და პროფესიონალური ონლაინ პრეზენცია, ბიუჯეტის მიუხედავად. ამიტომ ვეყრდნობი თანამედროვე დიზაინის ინსტრუმენტებსა და გამართულ სამუშაო პროცესებს, რათა შევქმნა ლამაზი, ეფექტური და პრაქტიკული ვებსაიტები ზედმეტი ხარჯების გარეშე.',
